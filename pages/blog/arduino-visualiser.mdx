...
export const meta = {
  ...
  author: 'ongzz',
  length: `${10*60*1000}`,
  img: '/static/arduino-visualiser/fft.png',
  date: "30-9-2021",
  blurb: "making an sussy audio visualiser for arduino",
  tags: ["devlog"]
}
...
# the enclosure
the project's almost done now: the thing i need next is an enclosure for the project.

i decided to go with a sussy crewmate model - the LED would pop up on its head 

unfortunately i had to switch to an Arduino Pro Mini :0
